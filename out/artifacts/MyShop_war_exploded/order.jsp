...
<script type="text/javascript">
	function addOrders(sum,uId) {
		location.href = "orders?method=addOrders&sum="+sum+"&uId="+uId+"&aId="+$("#address").val();
	}
</script>
</head>
...
<div class="container" style="background-color: white;">
	...
	<div class="row pull-right" style="margin-right: 40px;">
		 <div style="margin-bottom: 20px;">
	            <button  id="btn_add" class="btn  btn-danger btn-lg" type="button" onclick="addOrders(${sum},${loginUser.id})">提交订单</button>
	     </div>
	</div>
</div>
