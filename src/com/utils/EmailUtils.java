...
public class EmailUtils {
	public static void sendEmail(User user){
		//发送方
		String myAccount = "xkq1065917052@163.com";
		//授权码
		String myPass = "WNEGYCVVCBERKBYB";
		//发件人 邮箱的 SMTP 服务器地址
	...
	private static MimeMessage createMsg(Session session, String myAccount, User user) {
		...
		try {
			...
			String url = "http://"+ip+":8080/MyShop/user?method=active&email="+Base64Utils.encode(user.getEmail())+"&code="+Base64Utils.encode(user.getCode());
