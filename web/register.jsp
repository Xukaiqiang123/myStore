...
<script type="text/javascript">
	$(function(){
		$("#username").change(function(){
			...
			$.get("user","method=checkUsername&username="+this.value,function(data){
				if(data==1){
	...
	<div class="regist">
		<div class="regist_center">
			...
			<div class="center-block" style="margin-top: 80px;">
				<form class="form-horizontal" onsubmit="return checkPassword()" action="user?method=userRegister" method="post">
					...
					<div>${requestScope.registerSign}</div>
				</form>
