...
<body>
	...
	<div style="width: 80%;margin-left: 10%;">
		...
		<ul id="top_right" class="collapse navbar-collapse nav navbar-nav navbar-right"	style="margin-right: 20px;">
			<li>
				<a href="#">
					<span class="badge"	style="background-color: red;">${admin.username}</span>
				</a>
			</li>
			<li>
				<a href="../admin?method=adminLogOut">
		...
		<div class="page_main">
			<script type="text/javascript">
				...
				$("#showGoodsType").click(function(){
					$(".dv_content").attr("src","goodsType?method=showGoodsType");
				})
				$("#addGoodsType").click(function(){
					$(".dv_content").attr("src","goodsType?method=getTypes");
				})
				$("#showGoods").click(function(){
					$(".dv_content").attr("src","goods?method=showAllGoods");
				})
				$("#addGoods").click(function(){
					$(".dv_content").attr("src","addGoods.jsp");
				})
				$("#showOrder").click(function(){
					$(".dv_content").attr("src","orders?method=getAllOrders");
				})
			</script>
