...
<script type="text/javascript">
	...
	function payWeiXin(orderId,money){
		...
		//location.href="orders?method=payWeiXin&oid="+orderId+"&money="+money;
	}
</script>
</head>
...
<div class="panel panel-default" style="margin: 0 auto;width: 95%;">
	...
	<table cellpadding="0" cellspacing="0" align="center" width="100%" class="table table-striped table-bordered table-hover">
		...
		<tr>
			<td>收件人:</td>
			<td>${od.addressInfo.name}</td>
			<td>联系电话:</td>
			<td>${od.addressInfo.phone}</td>
		</tr>
		<tr>
			<td>送货地址:</td>
			<td>${od.addressInfo.detail}</td>
			<td>总价:</td>
			<td>${od.money}</td>
		</tr>
		<tr>
				...
				<table align="center" cellpadding="0" cellspacing="0" width="100%"  class="table table-striped table-bordered table-hover">
					...
					<c:forEach items="${od.list}" var="item" varStatus="i">
						<tr align="center">
							<th>${i.count}</th>
							<th>
								<img src="${item.goods.picture}" width="50px" height="50px">
							</th>
		...
		<tr>
			<td align="right" colspan="4" style="margin-right: 40px;">
				<a href="orders?method=getAllOrders" class="btn btn-danger btn-sm">返回订单列表</a>
				&nbsp;&nbsp;
